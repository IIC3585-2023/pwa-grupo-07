...
document.addEventListener('DOMContentLoaded', async function() {
    try {
        const eventData = await getEvent('11');
        const event = eventData[0]
        let transactionQuantity = event.transactions.length
        ...
        transactionResumeElement.innerHTML = `
                                            ...
                                            <div>
                                            Total of <span class="bold">${event.totalSpending} USD</span>
                                            </div>
                                            `;
